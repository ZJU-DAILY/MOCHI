...
static void execute_within_time_limit(execution_tree* tree, catalog* catalog, uint64_t output_limit, uint64_t time_limit) {
    g_exit = false;
...
static void output_embedding(const std::string& path, uint32_t *matching_order, uint32_t order_length,
...
int main(int argc, char** argv) {
    ...
    std::string input_export_plan_path = "../dataset/simple_dataset/result.txt";
...
//    std::string input_query_graph_file = "../dataset/simple_dataset/queryGraph.graph";
//    std::string input_data_graph_file = "../dataset/simple_dataset/matchGraph.graph";
